...
def _migrate_db():
    ...
    migrations = [
        ...
        "ALTER TABLE cards ADD COLUMN sm2_due_date DATETIME",
    ]
...
app = FastAPI(title="AnkiAI", version="0.3.0", lifespan=lifespan)

app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000", "https://ankiai.pages.dev"],
